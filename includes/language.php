...
// More
define('STATS_MSWG_FILE_SIZE', 'File size is too big');


// All Page Headings
// -----------------------------------------------------------

define('HOME', 'Welcome To ' . TITLE); // TITLE should be defined as a constant
define('LOGIN', 'Login');
...
define('CREATE_PLAYER_SUBMIT_LABEL', 'Create Account');
...
define('ADMIN_MANAGE_TABLES', 'Tables');
define('ADMIN_MANAGE_MEMBERS', 'Members');
define('ADMIN_MANAGE_ADDONS', 'Addons');
define('ADMIN_MANAGE_THEMES', 'Themes');
define('ADMIN_MANAGE_SETTINGS', 'Settings');
define('ADMIN_MANAGE_STYLES', 'Table Styles');
...
define('ADMIN_MEMBERS_NAME', 'Player');
...
define('ADMIN_MEMBERS_APPROVE', 'Status');
...
define('ADMIN_TABLES_GAME', 'Game Style');
...
define('ADMIN_TABLES_OPTIONS', 'Options');
define('ADMIN_TABLES_BB', 'Big blind');
define('ADMIN_TABLES_SB', 'Small blind');
define('BUTTON_SAVE', 'Save');
define('BUTTON_BACK', 'Back');
define('ADMIN_TOURNAMENT_TICKET', 'Ticket value');
define('ADMIN_TOURNAMENT_RAKE', 'Rake value');
define('ADMIN_TOURNAMENT_PRIZE_1', 'Prize 1');
define('ADMIN_TOURNAMENT_PRIZE_2', 'Prize 2');
define('ADMIN_TOURNAMENT_PRIZE_3', 'Prize 3');
define('ADMIN_TOURNAMENT_START_DATE', 'Start date and time');
...
define('GAME_MSG_CHIP_LEADER', 'is chip leader');
...
define('BUTTON_SMALLSCREEN', 'Small Screen'); // Switch to Small Screen
define('BUTTON_WIDESCREEN', 'Wide Screen'); // Switch to Wide Screen
define('GAME_TEXAS', "Texas Hold em");
define('GAME_OMAHA', "Omaha Hold em");
?>